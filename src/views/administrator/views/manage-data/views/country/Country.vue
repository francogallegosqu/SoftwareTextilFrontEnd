<template>
    <div>
        ...
        <b-row>
            ...
            <b-col cols="12" sm="12" md="5" lg="5" xl="5">
                <validation-observer ref="formSendRegister">
                    <b-row>
                        <t-register :isAvailable="false" :nameTitle="'País'" :formRegister="formRegister"
            ...
            <b-col cols="12" sm="12" md="7" lg="7" xl="7">
                <t-pagination-table :items="myProvider" :paginate="paginate">
                    <b-table ref="refListCountry" slot="table" sticky-header="40vh" responsive="sm" :items="myProvider"
                        :fields="fields" :current-page="paginate.currentPage" :per-page="paginate.perPage"
                        :busy.sync="isBusy" :hover="true">
                        <template #table-busy>
        ...
        <validation-observer ref="formSendUpdate">
            <t-update v-if="isUpdate" :isUpdate="isUpdate" :nameTitle="'País'" :formUpdate="formUpdate"
