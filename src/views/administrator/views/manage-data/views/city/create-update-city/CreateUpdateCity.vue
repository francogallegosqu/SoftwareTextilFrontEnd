  ...
  <b-row class="d-flex justify-content-center align-item-end">
      ...
      <b-row>
        <b-col cols="12" class="d-flex justify-content-center">
          <b-card class="card-create-city " >
            <h1 class="title-card-city p-1 mb-4 text-white text-center">Registra Tu nueva Ciudad</h1>
    ...
    <b-col cols="10" sm="6" md="5" lg="5" xl="4">
      <b-row>
        <b-col cols="12" class="d-flex justify-content-center">
          <b-card class="card-create-city " >
            <h1 class="title-card-city-update p-1 mb-4 text-white text-center">Actualiza Tu Ciudad</h1>
            <validation-observer ref="formCity">
            <b-form>
              <b-row>
                <!-- nameCity -->
